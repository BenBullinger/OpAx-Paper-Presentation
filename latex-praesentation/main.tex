...
\date[]{Foundations of Reinforcement Learning (263-5255-00L), Spring 2025} % Course info and date
...
\begin{frame}{Experiments: Reduction in Epistemic Uncertainty (ok)}
    ...
    \includegraphics[width=0.9\linewidth]{figures/uncertainty_plotvalidation_eps_std_max.pdf}
    \vspace{0.05in}
...
\begin{frame}{Experiments: Learning and Zero-Shot Generalization}
    ...
    \begin{columns}[T] % Align tops
         \begin{column}{0.6\textwidth}
            ...
            \begin{figure}
              \centering
              \subfloat[Trained task\label{fig:a}]{\includegraphics[width=0.37\linewidth]{figures/pendulum-keep-down.png}}
        
              \subfloat[Zero-shot task\label{fig:b}]{\includegraphics[width=0.37\linewidth]{figures/zero-shot-pendulum-swing-up.png}}
            %\caption{Evaluation}
            \label{fig:1}
            \end{figure}
         \end{column}
