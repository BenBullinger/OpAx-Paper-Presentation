...
\title{Paper Presentation: ``Optimistic Active Exploration of Dynamical Systems'' (Sukhija et al., 2023)}
...
\begin{frame}{Experiments: Learning and Zero-Shot Generalization}
...
\begin{frame}{Experiments: Learning and Zero-Shot Generalization}
    ...
    \begin{columns}[T] % Align tops
         \begin{column}{0.6\textwidth}
            ...
            \begin{figure}
              \centering
              \subfloat[Trained task\label{fig:a}]{\includegraphics[width=0.37\linewidth]{Latex_Praesentation/figures/pendulum-keep-down.png}}
        
              \subfloat[Zero-shot task\label{fig:b}]{\includegraphics[width=0.37\linewidth]{Latex_Praesentation/figures/zero-shot-pendulum-swing-up.png}}
            %\caption{Evaluation}
            \label{fig:1}
            \end{figure}
         \end{column}
         \begin{column}{0.4\textwidth}
            ...
            \begin{figure}
              \centering
              \subfloat[\texttt{H-UCRL}\label{fig:a}]{\movie[label=false,height=0.37\linewidth,width=0.37\linewidth]{(play)}{Latex_Praesentation/videos/hucrl-zero-shot-swingup-4.mov}}
        
              \subfloat[\texttt{OpAx}\label{fig:b}]{\movie[label=false,height=0.37\linewidth,width=0.37\linewidth]
                {(play)}{Latex_Praesentation/videos/opax-zero-shot-swingup-4.mov}}
            %\caption{Evaluation}
            \label{fig:1}
            \end{figure}
         \end{column}
